...
public class ShowMyContact implements InputMessageHandler{
    ...
    public ShowMyContact(ReplyMessagesService messagesService, MainMenuService mainMenuService) {
    ...
    public SendMessage handle(Message message) {
        return mainMenuService.getMainMenuMessage(message.getChatId(), messagesService.getReplyText("reply.showMyContact"));
    }
